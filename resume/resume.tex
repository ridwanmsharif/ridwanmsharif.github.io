...
\begin{rSection}{Work Experience}
  \begin{rSubsection}{Cockroach Labs}
    ...
    \item Improved overall read/write throughput
       ...
       \item Refactored CockroachDB's transaction model to support \href{https://github.com/cockroachdb/cockroach/pull/32688}
         {\underline{idempotent intra-transactional requests}}
       \item Added ordering within transactions
         \href{https://github.com/cockroachdb/cockroach/pull/33244}{\underline{introducing read/write semantics}} to solve the Halloween Problem
       \item Implemented workload generators to simulate different loads, distributions and request patterns
       \item Authored a \href{https://github.com/cockroachdb/cockroach/pull/30426}{\underline{design document}}
