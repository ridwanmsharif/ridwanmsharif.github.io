...
\begin{rSection}{Work Experience}
  \begin{rWorkSection}{Google}
		     ...
		     {June '21 -- Present}
    {
      \item Engineering lead of the managed OTel and Prometheus teams, enabling over \textbf{\$100M+} in revenue
      \item Enabled Prometheus collection for Cloud Run, unlocking observability of \textbf{1M+} serverless workloads
      \item Responsible for scalable collection, storage and telemetry routing solutions for \textbf{GKE}, \textbf{GCE}, \textbf{Cloud Run}, and other compute environments
